...
"use strict";var axios=require("axios"),keyApi=require("../constants");exports.add=function(){function a(a){axios.get("https://pixabay.com/api/?q=".concat(a,"&key=15682507-3e8e250fcfcf0d1690e9a1d6e")).then(function(a){return console.log(a.data.hits[0].largeImageUR)})}function b(b,c){({name:b,user:c,imageUrl:a(b)})}var c=document.getElementById("create-item"),d=document.getElementById("name"),e=document.getElementById("user");c.addEventListener("click",function(){var a=d.value,c=e.value;b(a,c)})};

},{"../constants":1,"axios":2}],31:[function(require,module,exports){
